  ...
  return (
    <main className="authPage">
      ...
      <section className="authCard">
        ...
        <h1>Sign in to Trust.Me.</h1>
        <p>Access saved assets, enquiries, and your marketplace activity.</p>
        ...
        <div className="authDivider">New to Trust.Me?</div>
        <Link className="secondary" href="/signup">Create an account</Link>
      </section>
