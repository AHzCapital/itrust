...
import { Bookmark, Check, Copy, ExternalLink, MoreHorizontal, Share2, UserPlus } from "lucide-react";
...
export default function PublicProfileClient({ username }: { username: string }) {
  ...
  useEffect(() => {
    ...
    else if (username === "trustme") setProfile({ name: "Trust.Me", username: "trustme", bio: "Verified assets. Trusted people. A better way to own with confidence.", location: "Egypt", image: "" });
